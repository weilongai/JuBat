...
PE.Eac_k = 0
PE.alpha = 0.5
PE.OCP = x-> -0.8090*x + 4.4875 - 0.0428*tanh(18.5138*(x - 0.5542)) - 17.7326*tanh(15.7890*(x - 0.3117)) + 17.5842*tanh(15.9308*(x - 0.3120))
PE.dOCP = x-> 279.9800214*(tanh(15.789*x - 4.9214313)^2) + 0.79239064*(tanh(18.5138*x - 10.26034796)^2) - 1.4510386800000594 - (280.13037336*(tanh(15.9308*x - 4.9704096)^2))
...
NE.Eac_k = 0.
NE.alpha = 0.5
NE.OCP = x-> 1.97938*exp(-39.3631*x) + 0.2482 - 0.0909*tanh(29.8538*(x - 0.1234)) - 0.04478*tanh(14.9159*(x - 0.2769)) - 0.0205*tanh(30.4444*(x - 0.6103))
NE.dOCP = x-> -0.62411*((sech(18.5802 - 30.4444*x))^2 + 4.34813*(sech(3.68396 - 29.8538*x))^2 + 1.07022*(sech(4.13021 - 14.9159*x))^2) - 211.794*exp(-39.3631*x)
