...
function sP2D_potentials(case::Case, yt::Array{Float64}, t::Float64, variables::Dict{String, Union{Array{Float64},Float64}})
    ...
    eta_p_gs_rel = phis_p .- phie_p_gs_rel - u_p_gs
    ...
    phis_p = 2.0 * log((- I_app + sqrt(4.0 * I_pp * I_pn + I_app^2.0)) / 2.0 / I_pp) + phie0
...
function phie_fit(x::Union{Array{Float64},Float64}, Li::Array{Float64}, ki::Array{Float64}, phie0::Float64)
